...
export const DemoVariant1 = () => {
  return (
    <div id="work" className="relative bg-white pt-16 sm:pt-20 pb-6 sm:pb-8 overflow-hidden">
      {/* ===================================================
          ATMOSPHERIC SOFT LIME-GREEN STUDIO LIGHT (SEAMLESSLY BLENDED)
         =================================================== */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-0 left-0 right-0 h-[550px] sm:h-[650px] z-0 overflow-hidden"
        style={{
          background: `
            radial-gradient(
      ...
      {/* Section Header */}
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center mb-6 sm:mb-10">
        {/* Section Label */}
        <motion.div
