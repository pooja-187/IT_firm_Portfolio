      ...
      <div className="w-full max-w-[1360px] mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-16 lg:mb-20">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-black/5 mb-5 shadow-xs"
          >
          ...
          <motion.h2
            ...
            className="font-sans text-4xl sm:text-5xl lg:text-6xl font-light text-[#111111] tracking-[-0.035em] leading-[1.12]"
          >
        ...
        {/* ===================================================
            4 VERTICAL EDITORIAL COLUMNS (FULL WIDTH GRID)
           =================================================== */}
          ...
          <div className="hidden md:grid md:grid-cols-4 relative border-l border-black/[0.08]">
            {VALUE_PROPOSITIONS.map((prop, idx) => (
              <motion.div
                ...
                className="group relative flex flex-col justify-between p-6 lg:p-7 xl:p-8 min-h-[380px] lg:min-h-[420px] xl:min-h-[440px] border-r border-black/[0.08] transition-all duration-500 hover:bg-white/80 hover:backdrop-blur-xs hover:shadow-[0_25px_50px_rgba(132,204,22,0.14)] cursor-default select-none overflow-hidden"
              >
