...
export default function ProcessSection() {
  return (
    <section
      ...
      className="relative w-full text-[#111111] pt-2 sm:pt-4 lg:pt-6 pb-16 sm:pb-24 lg:pb-32 overflow-hidden selection:bg-lime-200"
      style={{
        backgroundColor: '#FAFAF8',
        backgroundImage: `
          radial-gradient(
            ellipse 65% 42% at 50% 32%,
            rgba(190, 235, 105, 0.22) 0%,
            rgba(190, 235, 105, 0.10) 40%,
            rgba(190, 235, 105, 0.03) 65%,
            transparent 78%
          ),
          radial-gradient(
            ellipse 85% 55% at 52% 38%,
            rgba(190, 235, 105, 0.08) 0%,
            transparent 70%
          )
        `,
      }}
    >
      {/* ===================================================
          ATMOSPHERIC UPWARD-BLEED TRANSITION LAYER
          Smoothly bridges Process and About into one continuous visual light field
         =================================================== */}
      <div
        aria-hidden="true"
        className="absolute inset-x-0 bottom-0 h-[65%] pointer-events-none z-0"
        style={{
          background: `
            radial-gradient(
            ...
            linear-gradient(
              to top,
              rgba(190, 235, 105, 0.18) 0%,
              rgba(190, 235, 105, 0.09) 35%,
              rgba(190, 235, 105, 0.03) 68%,
              transparent 100%
            )
          `,
        }}
      ...
      <div className="relative z-10 w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block relative w-full max-w-[1180px] mx-auto">
          ...
          {/* SVG Lime Connector Lines Layer */}
          <svg
            aria-hidden="true"
  ...
  return (
    <motion.div
      ...
      className={`
        ...
        hover:shadow-[0_20px_45px_rgba(190,235,105,0.22)]
